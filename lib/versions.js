export const VERSIONS = [
  {
    ...
    summary: 'Create and edit Google Docs and Sheets directly inside the Hub. Upload files to auto-convert to Google format. Full collaboration with embedded editor, Hub-native annotations sidebar with notes and tags.',
    features: [
      'Create blank Google Docs or Sheets from within the Hub',
      'Upload .docx, .xlsx, .csv, .pdf, .md, .txt — auto-converts to Google format',
      'Embedded Google Docs/Sheets editor with full collaboration',
      'Annotations sidebar: notes, tags, project linking per document',
      'All documents stored in a shared "Discovery Hub" Google Drive folder',
      'Documents page with grid view, search, and project filter',
      'Link documents to projects',
      'Docs added to primary navigation and FAB quick actions',
      'Zip file preview on feed attachments — shows file tree without downloading',
      'News articles: Add to Feed and Add to Project buttons',
      'Meeting invites only sent to selected attendees',
    ],
  },
  {
    version: '2.2',
    date: 'March 25, 2026',
    title: 'Projects — Working Folders for Research Workstreams',
    summary: 'New Projects system for organizing feed posts, interviews, meetings, and reference links into workstreams. Visual project catalog with colored cards, per-project dashboards, and Add to Project from any feed post.',
    features: [
      'Projects page with visual card catalog (icon, color, summary, item count)',
      'Create Project with title, public URL, summary, description, icon, and color',
      'Project detail dashboard with linked feed posts, interviews, meetings, and reference links',
      'Add to Project picker on every feed post action row',
      'Add reference links and documents directly to projects',
      'Filter project items by type (feed, interview, meeting, link)',
      'Projects added to primary navigation and FAB quick actions',
      'Multiple file attachments on feed posts',
      'Drag-and-drop file upload on feed composer and meeting posts',
      'Horizontal Active Threads strip above feed',
      'Liquid glass meeting card styling with structured summaries',
      'View Full Transcript on completed meeting posts',
    ],
  },
  {
    version: '2.1',
    ...
    summary: 'Complete replacement of Fireflies.ai with Recall.ai for meeting bot and auto-transcription. Recall.ai provides reliable bot joining, direct bot lifecycle control, and deterministic meeting-to-transcript matching via stored bot ID.',
    features: [
      ...
      'Recall.ai webhook processes transcript completion with same Claude extraction pipeline',
      'Fireflies calendar attendee removed from Google Calendar event creation',
      'Fireflies webhook, GraphQL calls, and bot email fully removed',
    ],
  },
  {
    version: '2.0',
